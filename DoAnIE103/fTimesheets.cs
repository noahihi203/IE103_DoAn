...
namespace DoAnIE103
{
    public partial class fTimesheets : Form
    {
        public fTimesheets()
        {
            ...
            // Tạo một cột TimeColumn và thêm vào DataGridView
            TimeColumn timeColumn = new TimeColumn();
            timeColumn.HeaderText = "Time Column";
            dtgvTimesheet.Columns.Add(timeColumn);
            
            // Thêm một số hàng dữ liệu mẫu
